...
| 族 | 密度策略 | 正文页留白上限 | 末页留白上限 | strong 下限 | 姓名字号 | 头像区间 |
| --- | --- | --- | --- | --- | --- | --- |
| `tech` 技术 | 高密度：单页信息量优先 | 15% | 25% | 6 | 35px | 80-100px |
| `growth` 运营 / 增长 | 中密度：指标先行，数字比段落更早被读到 | 18% | 28% | 8 | 34px | 80-105px |
| `design` 视觉 / UI | 低密度：留白即作品 | 34% | 45% | 3 | 40px | 95-140px |
